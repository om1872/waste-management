...
<head>
  ...
  <?php
    ...
    <div class="content" style="background-color: #edeff0;">
      <span class="d-block" style="background-color: #a1a5ad;margin-left: 80px; padding: 10px; padding-left: 30px;"><p class="fs-4">Search Request</p></span>
      <div class="container p-4" style="background-color: whitesmoke; margin-left: 150px; margin-top: 50px;">
        <p class="fs-5" style="padding-bottom: 20px;"><b>Search By Complain Number</b></p>
      <hr>
      <div class="topnav">
        <?php
        ...
        $compno=$_POST["search"];
         ...
         $query = "SELECT * FROM complain where compID='$compno' and userID='$uid'";
         $result = mysqli_query($conn,$query);
        ...
        $qry="SELECT status from source where comp_no='$compno'";
      ...
      <tr> 
          <th scope "col"> <font face="Arial">Complain No.</font> </th> 
          <th scope "col"> <font face="Arial">UserID</font> </th> 
          <th scope "col"> <font face="Arial">Area</font> </th> 
          <th scope "col"> <font face="Arial">Locality</font> </th> 
          <th scope "col"> <font face="Arial">Landmark</font> </th> 
          <th scope "col"> <font face="Arial">Status</font> </th> 
      </tr>
      </thead>
      <tr> 
                  <td>'.$compno.'</td> 
      ...
      {
        echo "<div class='alert alert-danger'>complain not found</div>";
      }
      }
        ?>
        <form method="POST">

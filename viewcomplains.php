    ...
    <div class="content" style="background-color: #edeff0;">
      ...
      <div class="container p-4" style="background-color: white; margin-left: 150px; margin-top: 50px;">
        ...
        require_once "database.php";
         $query = "SELECT distinct * FROM complain,source where complain.compID=source.comp_no";
        ...
        if(is_null($driver))
        {
          ...
          $qry = "SELECT DriverName FROM driver where driver.DriverID='$driver'";
         $rsult = mysqli_query($conn,$qry);
        $dr=mysqli_fetch_array($rsult,MYSQLI_ASSOC);
        ...
        if(empty($status))
        {
          ...
          <div class="row row-cols-4">
            ...
            <div class="col-9 border p-3">'.$Landmark.'</div>
          </div>

          <div class="row row-cols-4">
            <div class="col border p-3 fw-semibold">Assign To</div>
            <div class="col border p-3">'.$driver.'</div>
